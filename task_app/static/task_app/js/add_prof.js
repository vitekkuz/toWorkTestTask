$(function ($) {
    $('#add_prof_form_id').submit(function (e) {
        e.preventDefault()
        $.ajax({
            type: this.method,
            url: this.action,
            ...
            success: function (response) {
                ...
                $('#v-pills-profession .table tbody').append([
                    ...
                    <td>` + response.ntext + ` (` +response.user_set + `)` + `
                                    ...
                                    <button type="button" class="btn" data-toggle="modal" data-target="#modifyProfession" id="prof_modify_icon_`+response.npk+`" onclick="openModifyForm(this)">
                ...
                b.click()
                console.log()
                console.log('Добавлено: ', response.npk)
